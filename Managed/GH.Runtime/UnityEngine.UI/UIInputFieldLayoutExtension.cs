...
[ExecuteInEditMode]
[AddComponentMenu("UI/Input Field - Layout Extension", 96)]
public class UIInputFieldLayoutExtension : MonoBehaviour, IEventSystemHandler, ISelectHandler, IDeselectHandler, IPointerEnterHandler, IPointerExitHandler
{
	...
	{
		if (!(targetGameObject == null) && !(animator == null) && animator.isActiveAndEnabled && !(animator.runtimeAnimatorController == null) && !string.IsNullOrEmpty(triggername))
		{
