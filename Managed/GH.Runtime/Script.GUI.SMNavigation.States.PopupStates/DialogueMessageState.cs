...
public class DialogueMessageState : PopupState
{
	public override PopupStateTag StateTag => PopupStateTag.DialogueMessage;

	public DialogueMessageState(UiNavigationManager navigationManager)
