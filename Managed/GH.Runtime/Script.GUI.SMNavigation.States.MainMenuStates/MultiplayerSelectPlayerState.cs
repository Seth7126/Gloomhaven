...
public class MultiplayerSelectPlayerState : MainMenuState
{
	...
	public override MainStateTag StateTag => MainStateTag.MultiplayerSelectPlayer;

	protected override bool SelectedFirst => true;

	protected override string RootName => "MultiplayerSelectPlayer";

	public MultiplayerSelectPlayerState(StateMachine stateMachine, UiNavigationManager navigationManager)
