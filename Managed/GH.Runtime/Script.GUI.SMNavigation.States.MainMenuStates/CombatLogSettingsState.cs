...
public class CombatLogSettingsState : MainMenuState
{
	...
	public override MainStateTag StateTag => MainStateTag.CombatLogSettings;

	protected override string RootName => "CombatLogSettings";

	public CombatLogSettingsState(StateMachine stateMachine, UiNavigationManager navigationManager)
