...
public class SettingsOptionsState : MainMenuState
{
	...
	public override MainStateTag StateTag => MainStateTag.SettingsOptions;

	protected override string RootName => "SettingsOptions";

	public SettingsOptionsState(StateMachine stateMachine, UiNavigationManager navigationManager)
