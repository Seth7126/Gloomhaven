...
public class GeneralSettingsState : MainMenuState
{
	...
	public override MainStateTag StateTag => MainStateTag.GeneralSettings;

	protected override string RootName => "GeneralSettings";

	public GeneralSettingsState(StateMachine stateMachine, UiNavigationManager navigationManager)
