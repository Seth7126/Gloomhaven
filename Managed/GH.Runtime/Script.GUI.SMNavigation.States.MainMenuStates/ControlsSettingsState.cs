...
public class ControlsSettingsState : MainMenuState
{
	...
	public override MainStateTag StateTag => MainStateTag.ControlSettings;

	protected override string RootName => "ControlSettings";

	public ControlsSettingsState(StateMachine stateMachine, UiNavigationManager navigationManager)
