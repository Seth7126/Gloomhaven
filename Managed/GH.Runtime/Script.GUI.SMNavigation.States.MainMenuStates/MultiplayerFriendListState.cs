...
public class MultiplayerFriendListState : MainMenuState
{
	...
	public override MainStateTag StateTag => MainStateTag.MultiplayerFriendList;

	protected override bool SelectedFirst => true;

	protected override string RootName => "MultiplayerFriendList";

	public MultiplayerFriendListState(StateMachine stateMachine, UiNavigationManager navigationManager)
