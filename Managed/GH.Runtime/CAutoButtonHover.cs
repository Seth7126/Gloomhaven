...
public class CAutoButtonHover : CAuto, ISerializable
{
	...
	protected CAutoButtonHover(SerializationInfo info, StreamingContext context)
		: base(info, context)
	{
		...
		while (enumerator.MoveNext())
		{
			...
			{
				LogUtils.LogError("Exception while trying to deserialize CAutoButtonHover entry " + current.Name + "\n" + ex.Message + "\n" + ex.StackTrace);
				throw ex;
			}
		}
	}
	...
	public CAutoButtonHover(int id, List<AutoLogUtility.ButtonAndOrder> buttonHierarchy)
		: base(EAutoType.ButtonHover, id)
	{
		base.Version = 2;
