...
public sealed class AbilityAugmentToken : IProtocolToken
{
	...
	public AbilityAugmentToken(int cardID, int actionTypeID, int consumeIndex, bool usesBothElements, int firstElementTypeID, int secondElementTypeID)
	{
		CardID = cardID;
