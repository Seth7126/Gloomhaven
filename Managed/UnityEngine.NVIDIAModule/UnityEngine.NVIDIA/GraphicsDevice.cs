...
public class GraphicsDevice
{
	...
	{
		cmd.IssuePluginEventAndData(NVUP_GetRenderEventCallback(), (int)pluginEvent, ptr);
	}
	...
	public DLSSContext CreateFeature(CommandBuffer cmd, in DLSSCommandInitializationData initSettings)
	{
		...
		DLSSContext dLSSContext = new DLSSContext(initSettings, NVUP_CreateFeatureSlot());
