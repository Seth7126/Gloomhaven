...
public class InputStateHistory : IDisposable, IEnumerable<InputStateHistory.Record>, IEnumerable, IInputStateChangeMonitor
{
	...
	unsafe void IInputStateChangeMonitor.NotifyControlStateChanged(InputControl control, double time, InputEventPtr eventPtr, long monitorIndex)
	{
		...
		if (((currentUpdateType & inputUpdateType) != InputUpdateType.None || ((currentUpdateType & (InputUpdateType.Dynamic | InputUpdateType.Fixed)) != InputUpdateType.None && (inputUpdateType & (InputUpdateType.Dynamic | InputUpdateType.Fixed)) != InputUpdateType.None && eventPtr.valid)) && (onShouldRecordStateChange == null || onShouldRecordStateChange(control, time, eventPtr)))
		{
