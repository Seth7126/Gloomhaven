...
internal class InputManager
{
	...
	private bool gameHasFocus => m_HasFocus;
	...
	public void AddDevice(InputDevice device)
	{
		...
		if (true && !m_HasFocus && m_Settings.backgroundBehavior != InputSettings.BackgroundBehavior.IgnoreFocus && m_Runtime.runInBackground && device.QueryEnabledStateFromRuntime() && !ShouldRunDeviceInBackground(device))
		{
	...
	internal void InitializeData()
	{
		...
		RegisterPrecompiledLayout<FastTouchscreen>("AutoWindowSpace;Touch;Vector2;Analog;TouchPress;Button;Axis;Integer;TouchPhase;Double;Touchscreen;Pointer");
		RegisterPrecompiledLayout<FastMouse>("AutoWindowSpace;Vector2;Button;Axis;Digital;Integer;Mouse;Pointer");
	...
	private unsafe void OnUpdate(InputUpdateType updateType, ref InputEventBuffer eventBuffer)
	{
		...
		bool flag3 = !m_HasFocus && !m_Runtime.runInBackground;
		...
		try
		{
			...
			while (m_InputEventStream.remainingEventCount > 0)
			{
				...
				if (!settings.disableRedundantEventsMerging && inputDevice.hasEventMerger && ptr2 != ptr)
				{
					...
					if (ptr3 != null && ptr2->deviceId == ptr3->deviceId)
					{
