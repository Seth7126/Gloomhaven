...
internal struct InputDeviceBuilder : IDisposable
{
	...
	private void FinalizeControlHierarchy()
	{
		...
		FinalizeControlHierarchyRecursive(m_Device, -1, m_Device.m_ChildrenForEachControl, noisy: false, dontReset: false);
	}
	...
	private void FinalizeControlHierarchyRecursive(InputControl control, int controlIndex, InputControl[] allControls, bool noisy, bool dontReset)
	{
		...
		for (int i = 0; i < childCount; i++)
		{
			...
			FinalizeControlHierarchyRecursive(inputControl, num, allControls, noisy, dontReset);
		}
