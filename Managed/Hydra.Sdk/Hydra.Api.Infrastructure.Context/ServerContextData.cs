...
public sealed class ServerContextData : IMessage<ServerContextData>, IMessage, IEquatable<ServerContextData>, IDeepCloneable<ServerContextData>, IBufferMessage
{
	private static readonly MessageParser<ServerContextData> _parser = new MessageParser<ServerContextData>(() => new ServerContextData());
	...
	[DebuggerNonUserCode]
	public static MessageParser<ServerContextData> Parser => _parser;

	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => ServerContextReflection.Descriptor.MessageTypes[1];
	...
	[DebuggerNonUserCode]
	public ServerContextData(ServerContextData other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	public ServerContextData Clone()
	{
		return new ServerContextData(this);
	}

	[DebuggerNonUserCode]
	public override bool Equals(object other)
	{
		return Equals(other as ServerContextData);
	}

	[DebuggerNonUserCode]
	public bool Equals(ServerContextData other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	public void MergeFrom(ServerContextData other)
	{
		if (other != null)
		{
