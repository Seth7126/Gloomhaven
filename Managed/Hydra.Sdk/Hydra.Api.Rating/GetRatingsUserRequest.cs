...
public sealed class GetRatingsUserRequest : IMessage<GetRatingsUserRequest>, IMessage, IEquatable<GetRatingsUserRequest>, IDeepCloneable<GetRatingsUserRequest>, IBufferMessage
{
	private static readonly MessageParser<GetRatingsUserRequest> _parser = new MessageParser<GetRatingsUserRequest>(() => new GetRatingsUserRequest());
	...
	[DebuggerNonUserCode]
	public static MessageParser<GetRatingsUserRequest> Parser => _parser;

	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => RatingContractsReflection.Descriptor.MessageTypes[8];
	...
	[DebuggerNonUserCode]
	public GetRatingsUserRequest()
	{
	}

	[DebuggerNonUserCode]
	public GetRatingsUserRequest(GetRatingsUserRequest other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	public GetRatingsUserRequest Clone()
	{
		return new GetRatingsUserRequest(this);
	}

	[DebuggerNonUserCode]
	public override bool Equals(object other)
	{
		return Equals(other as GetRatingsUserRequest);
	}

	[DebuggerNonUserCode]
	public bool Equals(GetRatingsUserRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	public void MergeFrom(GetRatingsUserRequest other)
	{
		if (other == null)
		{
			return;
