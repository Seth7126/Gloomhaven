...
public sealed class CreateServerResponse : IMessage<CreateServerResponse>, IMessage, IEquatable<CreateServerResponse>, IDeepCloneable<CreateServerResponse>, IBufferMessage
{
	private static readonly MessageParser<CreateServerResponse> _parser = new MessageParser<CreateServerResponse>(() => new CreateServerResponse());
	...
	[DebuggerNonUserCode]
	public static MessageParser<CreateServerResponse> Parser => _parser;

	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => SessionControlContractsReflection.Descriptor.MessageTypes[28];
	...
	[DebuggerNonUserCode]
	public CreateServerResponse(CreateServerResponse other)
		: this()
	{
