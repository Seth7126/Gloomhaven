...
public sealed class ClientGetTournamentsResponse : IMessage<ClientGetTournamentsResponse>, IMessage, IEquatable<ClientGetTournamentsResponse>, IDeepCloneable<ClientGetTournamentsResponse>, IBufferMessage
{
	private static readonly MessageParser<ClientGetTournamentsResponse> _parser = new MessageParser<ClientGetTournamentsResponse>(() => new ClientGetTournamentsResponse());
	...
	[DebuggerNonUserCode]
	public static MessageParser<ClientGetTournamentsResponse> Parser => _parser;

	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => ZenTournamentsContractsReflection.Descriptor.MessageTypes[30];
	...
	[DebuggerNonUserCode]
	public ClientGetTournamentsResponse()
	{
	}

	[DebuggerNonUserCode]
	public ClientGetTournamentsResponse(ClientGetTournamentsResponse other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	public ClientGetTournamentsResponse Clone()
	{
		return new ClientGetTournamentsResponse(this);
	}

	[DebuggerNonUserCode]
	public override bool Equals(object other)
	{
		return Equals(other as ClientGetTournamentsResponse);
	}

	[DebuggerNonUserCode]
	public bool Equals(ClientGetTournamentsResponse other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	public void MergeFrom(ClientGetTournamentsResponse other)
	{
		if (other != null)
		{
