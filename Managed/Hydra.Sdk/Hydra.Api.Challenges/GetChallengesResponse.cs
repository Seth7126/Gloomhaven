...
public sealed class GetChallengesResponse : IMessage<GetChallengesResponse>, IMessage, IEquatable<GetChallengesResponse>, IDeepCloneable<GetChallengesResponse>, IBufferMessage
{
	private static readonly MessageParser<GetChallengesResponse> _parser = new MessageParser<GetChallengesResponse>(() => new GetChallengesResponse());
	...
	[DebuggerNonUserCode]
	public static MessageParser<GetChallengesResponse> Parser => _parser;

	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => ChallengesContractsReflection.Descriptor.MessageTypes[3];
	...
	[DebuggerNonUserCode]
	public GetChallengesResponse(GetChallengesResponse other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	public GetChallengesResponse Clone()
	{
		return new GetChallengesResponse(this);
	}

	[DebuggerNonUserCode]
	public override bool Equals(object other)
	{
		return Equals(other as GetChallengesResponse);
	}

	[DebuggerNonUserCode]
	public bool Equals(GetChallengesResponse other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	public void MergeFrom(GetChallengesResponse other)
	{
		if (other == null)
		{
			return;
