...
public sealed class DisconnectRequest : IMessage<DisconnectRequest>, IMessage, IEquatable<DisconnectRequest>, IDeepCloneable<DisconnectRequest>, IBufferMessage
{
	...
	[DebuggerNonUserCode]
	public static MessageParser<DisconnectRequest> Parser => _parser;

	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => PresenceServiceContractsReflection.Descriptor.MessageTypes[2];
