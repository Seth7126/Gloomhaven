...
public static class AuthorizationApi
{
	public class AuthorizationApiClient : ClientBase<AuthorizationApiClient>
	{
		...
		public Task<SignInOculusResponse> SignInOculusAsync(SignInOculusRequest request)
		{
			return _caller.Execute<SignInOculusResponse, SignInOculusRequest>(Descriptor, "SignInOculus", request);
		}

		public Task<SignInHydraAuthTicketResponse> SignInHydraAuthTicketAsync(SignInHydraAuthTicketRequest request)
		{
			return _caller.Execute<SignInHydraAuthTicketResponse, SignInHydraAuthTicketRequest>(Descriptor, "SignInHydraAuthTicket", request);
		}

		public Task<SignInStandaloneCodeResponse> SignInStandaloneCodeAsync(SignInStandaloneCodeRequest request)
		{
			return _caller.Execute<SignInStandaloneCodeResponse, SignInStandaloneCodeRequest>(Descriptor, "SignInStandaloneCode", request);
		}

		public Task<SignInToolResponse> SignInToolAsync(SignInToolRequest request)
		{
			return _caller.Execute<SignInToolResponse, SignInToolRequest>(Descriptor, "SignInTool", request);
		}
		...
		public Task<GetStandaloneSignInCodeResponse> GetStandaloneSignInCodeAsync(GetStandaloneSignInCodeRequest request)
		{
			return _caller.Execute<GetStandaloneSignInCodeResponse, GetStandaloneSignInCodeRequest>(Descriptor, "GetStandaloneSignInCode", request);
		}

		public Task<SignInSecondaryResponse> SignInSecondaryAsync(SignInSecondaryRequest request)
		{
			return _caller.Execute<SignInSecondaryResponse, SignInSecondaryRequest>(Descriptor, "SignInSecondary", request);
		}
	}

	public static GenDescriptor Descriptor { get; } = new GenDescriptor("AuthorizationApi", "Hydra.Api.Auth.AuthorizationApi");
