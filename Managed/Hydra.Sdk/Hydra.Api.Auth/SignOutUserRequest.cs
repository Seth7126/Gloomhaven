...
public sealed class SignOutUserRequest : IMessage<SignOutUserRequest>, IMessage, IEquatable<SignOutUserRequest>, IDeepCloneable<SignOutUserRequest>, IBufferMessage
{
	private static readonly MessageParser<SignOutUserRequest> _parser = new MessageParser<SignOutUserRequest>(() => new SignOutUserRequest());
	...
	[DebuggerNonUserCode]
	public static MessageParser<SignOutUserRequest> Parser => _parser;

	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => AuthorizationContractsReflection.Descriptor.MessageTypes[27];
	...
	[DebuggerNonUserCode]
	public SignOutUserRequest()
	{
	}

	[DebuggerNonUserCode]
	public SignOutUserRequest(SignOutUserRequest other)
		: this()
	{
	...
	{
		return new SignOutUserRequest(this);
	}

	[DebuggerNonUserCode]
	public override bool Equals(object other)
	{
		return Equals(other as SignOutUserRequest);
	}

	[DebuggerNonUserCode]
	public bool Equals(SignOutUserRequest other)
	{
		if (other == null)
		{
			return false;
	...
	[DebuggerNonUserCode]
	public void MergeFrom(SignOutUserRequest other)
	{
		if (other == null)
		{
			return;
