...
public static class InputManager
{
	...
	public static bool HasVibration { get; set; } = true;
	...
	public static void AddDeviceManager<T>() where T : InputDeviceManager
	{
		AddDeviceManager(Activator.CreateInstance<T>());
	}
