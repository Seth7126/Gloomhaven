...
public abstract class GalaxyTypeAwareListenerChatRoomMessages : IGalaxyListener
{
	...
	public GalaxyTypeAwareListenerChatRoomMessages()
		: this(GalaxyInstancePINVOKE.new_GalaxyTypeAwareListenerChatRoomMessages(), cMemoryOwn: true)
	{
	...
	public override void Dispose()
	{
		lock (this)
		{
			if (swigCPtr.Handle != IntPtr.Zero)
			{
				...
				{
					swigCMemOwn = false;
					GalaxyInstancePINVOKE.delete_GalaxyTypeAwareListenerChatRoomMessages(swigCPtr);
				}
