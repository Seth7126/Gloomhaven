...
public sealed class SubpixelMorphologicalAntialiasing
{
	...
	internal void Render(PostProcessRenderContext context)
	{
		...
		command.GetTemporaryRT(ShaderIDs.SMAA_Flip, context.width, context.height, 0, FilterMode.Bilinear, context.sourceFormat, RenderTextureReadWrite.Linear, 1, enableRandomWrite: false, RenderTextureMemoryless.None, context.camera.allowDynamicResolution);
		command.GetTemporaryRT(ShaderIDs.SMAA_Flop, context.width, context.height, 0, FilterMode.Bilinear, context.sourceFormat, RenderTextureReadWrite.Linear, 1, enableRandomWrite: false, RenderTextureMemoryless.None, context.camera.allowDynamicResolution);
