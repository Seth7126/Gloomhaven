...
internal sealed class MultiScaleVO : IAmbientOcclusionMethod
{
	...
	private void PushAllocCommands(CommandBuffer cmd, bool isMSAA, Camera camera)
	{
		if (isMSAA)
		{
			Alloc(cmd, ShaderIDs.LinearDepth, MipLevel.Original, RenderTextureFormat.RGHalf, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.LowDepth1, MipLevel.L1, RenderTextureFormat.RGFloat, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.LowDepth2, MipLevel.L2, RenderTextureFormat.RGFloat, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.LowDepth3, MipLevel.L3, RenderTextureFormat.RGFloat, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.LowDepth4, MipLevel.L4, RenderTextureFormat.RGFloat, uav: true, camera.allowDynamicResolution);
			AllocArray(cmd, ShaderIDs.TiledDepth1, MipLevel.L3, RenderTextureFormat.RGHalf, uav: true, camera.allowDynamicResolution);
			AllocArray(cmd, ShaderIDs.TiledDepth2, MipLevel.L4, RenderTextureFormat.RGHalf, uav: true, camera.allowDynamicResolution);
			AllocArray(cmd, ShaderIDs.TiledDepth3, MipLevel.L5, RenderTextureFormat.RGHalf, uav: true, camera.allowDynamicResolution);
			AllocArray(cmd, ShaderIDs.TiledDepth4, MipLevel.L6, RenderTextureFormat.RGHalf, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.Occlusion1, MipLevel.L1, RenderTextureFormat.RG16, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.Occlusion2, MipLevel.L2, RenderTextureFormat.RG16, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.Occlusion3, MipLevel.L3, RenderTextureFormat.RG16, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.Occlusion4, MipLevel.L4, RenderTextureFormat.RG16, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.Combined1, MipLevel.L1, RenderTextureFormat.RG16, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.Combined2, MipLevel.L2, RenderTextureFormat.RG16, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.Combined3, MipLevel.L3, RenderTextureFormat.RG16, uav: true, camera.allowDynamicResolution);
		}
		else
		{
			Alloc(cmd, ShaderIDs.LinearDepth, MipLevel.Original, RenderTextureFormat.RHalf, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.LowDepth1, MipLevel.L1, RenderTextureFormat.RFloat, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.LowDepth2, MipLevel.L2, RenderTextureFormat.RFloat, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.LowDepth3, MipLevel.L3, RenderTextureFormat.RFloat, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.LowDepth4, MipLevel.L4, RenderTextureFormat.RFloat, uav: true, camera.allowDynamicResolution);
			AllocArray(cmd, ShaderIDs.TiledDepth1, MipLevel.L3, RenderTextureFormat.RHalf, uav: true, camera.allowDynamicResolution);
			AllocArray(cmd, ShaderIDs.TiledDepth2, MipLevel.L4, RenderTextureFormat.RHalf, uav: true, camera.allowDynamicResolution);
			AllocArray(cmd, ShaderIDs.TiledDepth3, MipLevel.L5, RenderTextureFormat.RHalf, uav: true, camera.allowDynamicResolution);
			AllocArray(cmd, ShaderIDs.TiledDepth4, MipLevel.L6, RenderTextureFormat.RHalf, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.Occlusion1, MipLevel.L1, RenderTextureFormat.R8, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.Occlusion2, MipLevel.L2, RenderTextureFormat.R8, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.Occlusion3, MipLevel.L3, RenderTextureFormat.R8, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.Occlusion4, MipLevel.L4, RenderTextureFormat.R8, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.Combined1, MipLevel.L1, RenderTextureFormat.R8, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.Combined2, MipLevel.L2, RenderTextureFormat.R8, uav: true, camera.allowDynamicResolution);
			Alloc(cmd, ShaderIDs.Combined3, MipLevel.L3, RenderTextureFormat.R8, uav: true, camera.allowDynamicResolution);
		}
	}
	...
	private void PushDownsampleCommands(CommandBuffer cmd, Camera camera, RenderTargetIdentifier? depthMap, bool isMSAA)
	{
		...
		{
			Alloc(cmd, ShaderIDs.DepthCopy, MipLevel.Original, RenderTextureFormat.RFloat, uav: false, camera.allowDynamicResolution);
