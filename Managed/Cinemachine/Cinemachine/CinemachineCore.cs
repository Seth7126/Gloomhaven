...
public sealed class CinemachineCore
{
	...
	public static AxisInputDelegate GetInputAxis = (string _003Cp0_003E) => 0f;
	...
	public CinemachineVirtualCameraBase GetVirtualCamera(int index)
	{
		...
		{
			mActiveCameras.Sort((CinemachineVirtualCameraBase x, CinemachineVirtualCameraBase y) => (x.Priority != y.Priority) ? (y.Priority - x.Priority) : (y.m_ActivationId - x.m_ActivationId));
