...
public struct Query
{
	...
	public async Task<ResultPage?> GetPageAsync(int page)
	{
		...
		return new ResultPage
		{
			...
			ReturnsKeyValueTags = (WantsReturnKeyValueTags == true),
			ReturnsDefaultStats = (WantsDefaultStats ?? true),
			ReturnsMetadata = (WantsReturnMetadata == true),
			ReturnsChildren = (WantsReturnChildren == true),
			ReturnsAdditionalPreviews = (WantsReturnAdditionalPreviews == true)
		};
	}
