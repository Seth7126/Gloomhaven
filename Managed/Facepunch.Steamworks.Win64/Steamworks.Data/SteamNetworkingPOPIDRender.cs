...
internal struct SteamNetworkingPOPIDRender
{
	[MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)]
	internal byte[] Buf;

	[DllImport("steam_api64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_SteamNetworkingPOPIDRender_c_str")]
