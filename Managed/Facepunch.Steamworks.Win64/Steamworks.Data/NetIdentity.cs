...
public struct NetIdentity
{
	...
	[DllImport("steam_api64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_SteamNetworkingIdentity_SetStadiaID")]
	internal static extern void InternalSetStadiaID(ref NetIdentity self, ulong id);

	[DllImport("steam_api64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "SteamAPI_SteamNetworkingIdentity_GetStadiaID")]
