...
public class Physics2D
{
	...
	public static extern bool GetIgnoreCollision([Writable][NotNull("ArgumentNullException")] Collider2D collider1, [Writable][NotNull("ArgumentNullException")] Collider2D collider2);
	...
	private static bool IsTouching_TwoCollidersWithFilter([Writable][NotNull("ArgumentNullException")] Collider2D collider1, [NotNull("ArgumentNullException")][Writable] Collider2D collider2, ContactFilter2D contactFilter)
	{
