...
public class CAbilityChoose : CAbilityTargeting
{
	public List<CAbility> ChooseAbilities { get; private set; }

	public CAbilityChoose(List<CAbility> chooseAbilities)
		: base(EAbilityType.ChooseAbility)
	{
	...
	public CAbilityChoose()
	{
	}

	public CAbilityChoose(CAbilityChoose state, ReferenceDictionary references)
