...
[Serializable]
public class CPlayerStatsDonations : CPlayerStatsAction, ISerializable
{
	public int Amount { get; private set; }

	public CPlayerStatsDonations()
	{
	}

	public CPlayerStatsDonations(CPlayerStatsDonations state, ReferenceDictionary references)
	...
	public CPlayerStatsDonations(SerializationInfo info, StreamingContext context)
		: base(info, context)
	{
		...
		while (enumerator.MoveNext())
		{
			...
			{
				DLLDebug.LogError("Exception while trying to deserialize CPlayerStatsDonations entry " + current.Name + "\n" + ex.Message + "\n" + ex.StackTrace);
				throw ex;
			}
		}
	}
