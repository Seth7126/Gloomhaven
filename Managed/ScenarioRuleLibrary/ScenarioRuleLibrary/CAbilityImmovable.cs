...
public class CAbilityImmovable : CAbilityCondition
{
	public CAbilityImmovable()
		: base(EAbilityType.Immovable, int.MaxValue, EConditionDecTrigger.Never)
	{
	}
	...
	public void ApplyThisCondition(CActor actor)
	{
		actor.ApplyCondition(base.TargetingActor, CCondition.EPositiveCondition.Immovable);
	}

	public CAbilityImmovable(CAbilityImmovable state, ReferenceDictionary references)
