...
public class CAbilitySleep : CAbilityCondition
{
	public CAbilitySleep()
		: base(EAbilityType.Sleep, int.MaxValue, EConditionDecTrigger.Never)
	{
	}
	...
	public override bool ApplyToActor(CActor actor)
	{
		if (base.ApplyToActor(actor))
		{
			...
			{
				actor.ApplyCondition(base.TargetingActor, CCondition.ENegativeCondition.Sleep, base.Duration, base.DecrementTrigger);
	...
	public CAbilitySleep(CAbilitySleep state, ReferenceDictionary references)
