...
public class CAbilityDisarm : CAbilityCondition
{
	public CAbilityDisarm(int duration, EConditionDecTrigger decTrigger)
		: base(EAbilityType.Disarm, duration, decTrigger)
	{
	}
	...
	public override bool ApplyToActor(CActor actor)
	{
		if (base.ApplyToActor(actor))
		{
			...
			{
				actor.ApplyCondition(base.TargetingActor, CCondition.ENegativeCondition.Disarm, base.Duration, base.DecrementTrigger);
	...
	public CAbilityDisarm()
	{
	}

	public CAbilityDisarm(CAbilityDisarm state, ReferenceDictionary references)
