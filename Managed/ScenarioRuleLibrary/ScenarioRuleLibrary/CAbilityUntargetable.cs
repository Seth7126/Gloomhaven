...
public class CAbilityUntargetable : CAbilityTargeting
{
	public CAbilityUntargetable()
		: base(EAbilityType.Untargetable)
	{
	}
	...
	public CAbilityUntargetable(CAbilityUntargetable state, ReferenceDictionary references)
