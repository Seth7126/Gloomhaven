...
public class CAbilityMuddle : CAbilityCondition
{
	public CAbilityMuddle(int duration, EConditionDecTrigger decTrigger)
		: base(EAbilityType.Muddle, duration, decTrigger)
	{
	}
	...
	public override bool ApplyToActor(CActor actor)
	{
		if (base.ApplyToActor(actor))
		{
			...
			{
				actor.ApplyCondition(base.TargetingActor, CCondition.ENegativeCondition.Muddle, base.Duration, base.DecrementTrigger);
	...
	public CAbilityMuddle()
	{
	}

	public CAbilityMuddle(CAbilityMuddle state, ReferenceDictionary references)
