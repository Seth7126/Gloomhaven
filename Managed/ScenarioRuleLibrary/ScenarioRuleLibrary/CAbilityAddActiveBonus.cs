...
public class CAbilityAddActiveBonus : CAbilityTargeting
{
	public CAbility AddAbility { get; set; }

	public CAbilityAddActiveBonus(CAbility addAbility)
		: base(EAbilityType.AddActiveBonus)
	{
	...
	public override bool ApplyToActor(CActor actor)
	{
		if (base.ApplyToActor(actor))
		{
			...
			CAddActiveBonus_MessageData message = new CAddActiveBonus_MessageData(base.AnimOverload, base.TargetingActor)
			{
				m_AddActiveBonus = this,
	...
	public CAbilityAddActiveBonus()
	{
	}

	public CAbilityAddActiveBonus(CAbilityAddActiveBonus state, ReferenceDictionary references)
