...
[Serializable]
public class CPlayerStatsBattlePerks : CPlayerStatsAction, ISerializable
{
	public int Amount { get; private set; }

	public CPlayerStatsBattlePerks()
	{
	}

	public CPlayerStatsBattlePerks(CPlayerStatsBattlePerks state, ReferenceDictionary references)
	...
	public CPlayerStatsBattlePerks(SerializationInfo info, StreamingContext context)
		: base(info, context)
	{
