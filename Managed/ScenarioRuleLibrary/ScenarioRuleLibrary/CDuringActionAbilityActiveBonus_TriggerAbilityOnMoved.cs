...
public class CDuringActionAbilityActiveBonus_TriggerAbilityOnMoved : CBespokeBehaviour
{
	...
	public CDuringActionAbilityActiveBonus_TriggerAbilityOnMoved(CActor actor, CAbility ability, CActiveBonus activeBonus)
	...
	public CDuringActionAbilityActiveBonus_TriggerAbilityOnMoved()
	{
	}

	public CDuringActionAbilityActiveBonus_TriggerAbilityOnMoved(CDuringActionAbilityActiveBonus_TriggerAbilityOnMoved state, ReferenceDictionary references)
