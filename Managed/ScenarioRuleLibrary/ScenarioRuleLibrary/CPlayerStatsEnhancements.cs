...
[Serializable]
public class CPlayerStatsEnhancements : CPlayerStatsAction, ISerializable
{
	public int Amount { get; private set; }

	public CPlayerStatsEnhancements()
	{
	}

	public CPlayerStatsEnhancements(CPlayerStatsEnhancements state, ReferenceDictionary references)
	...
	public CPlayerStatsEnhancements(SerializationInfo info, StreamingContext context)
		: base(info, context)
	{
