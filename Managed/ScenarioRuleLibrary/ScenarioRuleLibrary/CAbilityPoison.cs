...
public class CAbilityPoison : CAbilityCondition
{
	public CAbilityPoison()
		: base(EAbilityType.Poison, int.MaxValue, EConditionDecTrigger.Never)
	{
	}
	...
	public override bool ApplyToActor(CActor actor)
	{
		if (base.ApplyToActor(actor))
		{
			...
			{
				actor.ApplyCondition(base.TargetingActor, CCondition.ENegativeCondition.Poison);
	...
	public CAbilityPoison(CAbilityPoison state, ReferenceDictionary references)
