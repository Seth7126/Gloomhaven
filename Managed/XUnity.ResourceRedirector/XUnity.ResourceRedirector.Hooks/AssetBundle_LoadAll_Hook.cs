...
{
	private delegate Object[] OriginalMethod(AssetBundle __instance, Type type);
	...
	private static bool Prefix(AssetBundle __instance, ref Type type, ref Object[] __result, ref AssetLoadingContext __state)
	{
	...
	private static Object[] MM_Detour(AssetBundle __instance, Type type)
	{
		Object[] __result = null;
		AssetLoadingContext __state = null;
		if (Prefix(__instance, ref type, ref __result, ref __state))
		{
