...
public class WheelColliderTimeline : ComponentTimeline<WheelCollider>
{
	...
	{
		JointSpring suspensionSpring = source.suspensionSpring;
	...
	{
		JointSpring suspensionSpring = base.component.suspensionSpring;
		base.component.suspensionSpring = suspensionSpring;
	}
}
