	...
	private void ChangeArc()
	{
		...
		if (source != null && target != null)
		{
			for (int i = 0; i < points; i++)
			{
				...
				trail.points.Add(new AraTrail.Point(vector + UnityEngine.Random.onUnitSphere * positionRandom * num2, UnityEngine.Random.onUnitSphere * speedRandom * num2, Vector3.up, Vector3.forward, Color.white, 1f, burstInterval * 2f));
			}
		}
	}
}
