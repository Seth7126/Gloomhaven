...
public abstract class BaseInputModule : UIBehaviour
{
	...
	protected void HandlePointerExitAndEnter(PointerEventData currentPointerData, GameObject newEnterTarget)
	{
		...
		if (currentPointerData.pointerEnter != null)
		{
			...
			while (parent != null && (!(parent.gameObject == newEnterTarget) || !(parent.gameObject == gameObject)))
			{
		...
		while (parent2 != null && (!(parent2.gameObject != newEnterTarget) || !(parent2.gameObject == gameObject)))
		{
			currentPointerData.reentered = parent2.gameObject == gameObject;
