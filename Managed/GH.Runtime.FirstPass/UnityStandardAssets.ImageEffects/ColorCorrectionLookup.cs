...
public class ColorCorrectionLookup : PostEffectsBase
{
	...
	public void Convert(Texture2D temp2DTex, string path)
	{
		if ((bool)temp2DTex)
		{
			...
			{
				LogUtils.LogWarning("The given 2D texture " + temp2DTex.name + " cannot be used as a 3D LUT.");
				basedOnTempTex = "";
				return;
			}
		...
		{
			LogUtils.LogError("Couldn't color correct with 3D LUT texture. Image Effect will be disabled.");
		}
	}
