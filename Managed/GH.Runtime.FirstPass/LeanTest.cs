...
public class LeanTest
{
	...
	public static void expect(bool didPass, string definition, string failExplaination = null)
	{
		...
		{
			LogUtils.Log(formatB("Too many tests for a final report!") + " set LeanTest.expected = " + tests);
		}
		if (!timeoutStarted)
		{
			timeoutStarted = true;
	...
	public static void overview()
	{
		...
		LogUtils.Log(formatB("Final Report:") + " _____________________ PASSED: " + formatBC(passes.ToString() ?? "", "green") + " FAILED: " + text + " ");
	}
}
