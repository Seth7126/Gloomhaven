...
internal class ManateeBoardBackground : IJsonBoardBackground, IJsonCacheable, IAcceptId, IJsonSerializable
{
	...
	public void FromJson(JsonValue json, JsonSerializer serializer)
	{
		...
		case JsonValueType.Object:
		{
			...
			Brightness = obj.Deserialize<BoardBackgroundBrightness?>(serializer, "brightness") ?? obj.Deserialize<BoardBackgroundBrightness?>(serializer, "backgroundBrightness");
			...
			ImageScaled = obj.Deserialize<List<IJsonImagePreview>>(serializer, "scaled") ?? obj.Deserialize<List<IJsonImagePreview>>(serializer, "backgroundImageScaled");
			...
			Type = obj.Deserialize<BoardBackgroundType?>(serializer, "type") ?? obj.Deserialize<BoardBackgroundType?>(serializer, "backgroundType");
			ValidForMerge = true;
			break;
		}
