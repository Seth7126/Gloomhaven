...
internal class ManateeActionData : IJsonActionData, IJsonSerializable
{
	...
	public void FromJson(JsonValue json, JsonSerializer serializer)
	{
		if (json.Type == JsonValueType.Object)
		{
			...
			Member = obj.Deserialize<IJsonMember>(serializer, "member") ?? obj.Deserialize<IJsonMember>(serializer, "idMember") ?? obj.Deserialize<IJsonMember>(serializer, "idMemberAdded");
			Old = obj.Deserialize<IJsonActionOldData>(serializer, "old");
			Org = obj.Deserialize<IJsonOrganization>(serializer, "org") ?? obj.Deserialize<IJsonOrganization>(serializer, "organization");
