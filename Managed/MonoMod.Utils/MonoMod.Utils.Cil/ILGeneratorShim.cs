...
{
	private static class ILGeneratorBuilder
	{
		...
		public static Type GenerateProxy()
		{
			...
			}))
			{
				...
				TypeReference item = moduleDefinition.ImportReference(typeFromHandle2);
			...
			return ProxyType = assembly.GetType("MonoMod.Utils.Cil.ILGeneratorProxy");
		}
	}
	...
	{
		return ProxyType.MakeGenericType(tShim);
	}
}
