...
internal class InitializationContext : IInitializationContext
{
	...
	internal InitializationContext(HttpSecurity httpSecurity, string sourceLanguage, string destinationLanguage)
	{
	...
	public void SetTranslationDelay(float delayInSeconds)
	{
		...
		{
			throw new ArgumentException("delayInSecond must not be lower than 0.1 seconds.", "delayInSeconds");
		}
