...
internal class ZipFile : IEnumerable
{
	...
	private void ReadEntries()
	{
		...
		for (int i = 0; i < num4; i++)
		{
			...
			zipEntry.Crc = num10 & 0xFFFFFFFFL;
			zipEntry.Size = num12 & 0xFFFFFFFFL;
			zipEntry.CompressedSize = num11 & 0xFFFFFFFFL;
	...
	public ZipEntry GetEntry(string name)
	{
		...
		return (num < 0) ? null : ((ZipEntry)entries[num].Clone());
	}
