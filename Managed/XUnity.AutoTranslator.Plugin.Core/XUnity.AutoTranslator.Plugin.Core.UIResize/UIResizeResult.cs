...
internal class UIResizeResult
{
	...
	public bool IsEmpty()
	{
		if (ResizeCommand == null && AutoResizeCommand == null && LineSpacingCommand == null && HorizontalOverflowCommand == null && VerticalOverflowCommand == null && OverflowCommand == null)
		{
			return AlignmentCommand == null;
		}
		return false;
	}
