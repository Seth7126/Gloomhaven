...
internal class UGUI_ChangeLineSpacingByPercentage : IUGUI_LineSpacingCommand
{
	private float _perc;
	...
	public UGUI_ChangeLineSpacingByPercentage(string[] args)
	{
		if (args.Length != 1)
		{
			throw new ArgumentException("UGUI_ChangeLineSpacingByPercentage requires one argument.");
		}
