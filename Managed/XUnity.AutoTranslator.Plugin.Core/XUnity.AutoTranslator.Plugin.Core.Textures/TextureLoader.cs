...
internal static class TextureLoader
{
	...
	{
		Loaders = new Dictionary<ImageFormat, ITextureLoader>();
		Register(ImageFormat.PNG, new LoadImageImageLoader());
		if (Register(ImageFormat.TGA, new TgaImageLoader()))
		{
			_ = 1;
		}
		else
			Register(ImageFormat.TGA, new FallbackTgaImageLoader());
	}
	...
	{
		if (Loaders.TryGetValue(imageFormat, out var value))
		{
