...
{
	private static Action<Component, char[]> _original;
	...
	{
		return AccessToolsShim.Method(UnityTypes.TMP_Text?.ClrType, "SetCharArray", typeof(char[]));
	}
	...
	private static void MM_Detour(Component __instance, char[] value)
	{
