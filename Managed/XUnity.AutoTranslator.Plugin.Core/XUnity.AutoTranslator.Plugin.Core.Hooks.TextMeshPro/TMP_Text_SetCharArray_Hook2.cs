...
{
	private static Action<Component, char[], int, int> _original;
	...
	{
		return AccessToolsShim.Method(UnityTypes.TMP_Text?.ClrType, "SetCharArray", typeof(char[]), typeof(int), typeof(int));
	}
	...
	private static void MM_Detour(Component __instance, char[] value, int arg2, int arg3)
	{
