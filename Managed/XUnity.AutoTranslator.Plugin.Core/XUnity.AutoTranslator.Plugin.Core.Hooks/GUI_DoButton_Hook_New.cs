...
{
	private static Func<Rect, int, GUIContent, GUIStyle, bool> _original;
	...
	{
		return AccessToolsShim.Method(UnityTypes.GUI.ClrType, "DoButton", typeof(Rect), typeof(int), typeof(GUIContent), typeof(GUIStyle));
	}
	...
	private static bool MM_Detour(Rect arg1, int arg2, GUIContent arg3, GUIStyle arg4)
	{
