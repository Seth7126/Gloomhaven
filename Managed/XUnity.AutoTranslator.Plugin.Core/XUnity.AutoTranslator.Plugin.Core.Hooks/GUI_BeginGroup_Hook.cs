...
{
	private static Action<Rect, GUIContent, GUIStyle> _original;
	...
	{
		return AccessToolsShim.Method(UnityTypes.GUI.ClrType, "BeginGroup", typeof(Rect), typeof(GUIContent), typeof(GUIStyle));
	}
	...
	private static void MM_Detour(Rect arg1, GUIContent arg2, GUIStyle arg3)
	{
