...
{
	private static Func<Object, Vector3, Quaternion, Object> _original;
	...
	{
		return AccessToolsShim.Method(UnityTypes.Object.ClrType, "Internal_InstantiateSingle", typeof(Object), typeof(Vector3), typeof(Quaternion));
	}

	private static void MM_Init(object detour)
	{
		_original = detour.GenerateTrampolineEx<Func<Object, Vector3, Quaternion, Object>>();
	}

	private static Object MM_Detour(Object data, Vector3 pos, Quaternion rot)
	{
		...
		try
		{
			...
			Object val = _original(data, pos, rot);
