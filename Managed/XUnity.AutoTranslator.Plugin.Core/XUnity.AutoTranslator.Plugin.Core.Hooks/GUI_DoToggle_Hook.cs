...
{
	private delegate bool OriginalMethod(Rect arg1, int arg2, bool arg3, GUIContent arg4, IntPtr arg5);
	...
	{
		return AccessToolsShim.Method(UnityTypes.GUI.ClrType, "DoToggle", typeof(Rect), typeof(int), typeof(bool), typeof(GUIContent), typeof(IntPtr));
	}
	...
	private static bool MM_Detour(Rect arg1, int arg2, bool arg3, GUIContent arg4, IntPtr arg5)
	{
