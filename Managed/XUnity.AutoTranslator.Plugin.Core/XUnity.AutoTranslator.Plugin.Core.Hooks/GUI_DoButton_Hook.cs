...
{
	private static Func<Rect, GUIContent, IntPtr, bool> _original;
	...
	{
		return AccessToolsShim.Method(UnityTypes.GUI.ClrType, "DoButton", typeof(Rect), typeof(GUIContent), typeof(IntPtr));
	}
	...
	private static bool MM_Detour(Rect arg1, GUIContent arg2, IntPtr arg3)
	{
